...
public class BankData implements Serializable {
    ...
    public void addStaff(Staff s) { staff.put(s.getUsername(), s); }
    public Staff getStaff(String username) { return staff.get(username); }
    public Collection<Staff> getAllStaff() { return staff.values(); }

    public void addAdmin(Admin a) { admins.put(a.getUsername(), a); }
    public Admin getAdmin(String username) { return admins.get(username); }
